...
if(isset($_POST['sub'])){
  ...
  $sql = "update cars set cname='".$cname."', cbrand='".$brand."', variants='".$variants."', price='".$price."', engine='".$engine."', transmission='".$transmission."', fueltype='".$fuel."', seatingcapacity='".$seating."', aditionaldetails='".$additional."', photo='".$image."' where cid='".$carid."'";
...
<div class="row">
  ...
  <center>
    ...
    <?php echo $msg ?>
    <?php
     $qry = "select * from cars where cid='".$carid."'";
     $result = mysqli_query($con, $qry);
     $row1= mysqli_fetch_array($result);
     ?>
     <form action="" method="post" enctype="multipart/form-data">
           
           <input type="text" value="<?php echo $row1['cname']; ?>" name="cname" placeholder="Enter Model of the car" required="required" style="padding: 6px; width: 60%; border: 2px solid; border-radius: 6px;"></br><br>
           <input type="text" value="<?php echo $row1['cbrand']; ?>" name="cbrand" placeholder="Enter brand of the car" required="required" style="padding: 6px; width: 60%; border: 2px solid; border-radius: 6px;"></br><br>
           <input type="text" value="<?php echo $row1['variants']; ?>" name="variants" placeholder="Enter variants of the car" required="required" style="padding: 6px; width: 60%; border: 2px solid; border-radius: 6px;"></br><br>
           <input type="text" value="<?php echo $row1['price']; ?>" name="price" placeholder="Enter price of the car" required="required" style="padding: 6px; width: 60%; border: 2px solid; border-radius: 6px;"></br><br>
           <input type="text" value="<?php echo $row1['engine']; ?>" name="engine" placeholder="Enter engine of the car" required="required" style="padding: 6px; width: 60%; border: 2px solid; border-radius: 6px;"></br><br>
           <input type="text" value="<?php echo $row1['transmission']; ?>" name="transmission" placeholder="Transmission" required="required" style="padding: 6px; width: 60%; border: 2px solid; border-radius: 6px;"></br><br>
           <input type="text" value="<?php echo $row1['fueltype']; ?>" name="fuel" placeholder="Fuel type of the car" required="required" style="padding: 6px; width: 60%; border: 2px solid; border-radius: 6px;"></br><br>
           <input type="text" value="<?php echo $row1['seatingcapacity']; ?>" name="seating" placeholder="Seating capacity of the car" required="required" style="padding: 6px; width: 60%; border: 2px solid; border-radius: 6px;"></br><br>
           ...
           <input type="text" value="<?php echo $row1['aditionaldetails']; ?>" name="additional" placeholder="Any additional details of the car" required="required" style="padding: 6px; width: 60%; border: 2px solid; border-radius: 6px;"></br><br>
